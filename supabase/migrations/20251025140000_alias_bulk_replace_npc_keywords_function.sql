-- migration: fix ambiguous id reference in bulk_replace_npc_keywords rpc
-- purpose: qualify table columns to avoid clash with OUT parameter names
...
begin
  ...
  return query
    ...
    order by results.sort_index, results.created_at, results.keyword_id;
end;
$$;
